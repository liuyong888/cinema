...
function() {
    "use strict";
    var s, e, o = Object.assign ||
    function(e) {
        for (var n, o = 1,
        t = arguments.length; o < t; o++) for (var i in n = arguments[o]) Object.prototype.hasOwnProperty.call(n, i) && (e[i] = n[i]);
        return e
    }; (e = s || (s = {})).CANCEL_LOGIN = "cancelLogin",
    e.COMP_INNER = "iLoginCompInner",
    e.CODE_ID = "sendCodeBtn",
    e.LOGIN_ID = "iloginBtn",
    e.PHONE_NUM_INPUT_ID = "phoneNumInput",
    e.CODE_INPUT_ID = "codeInput",
    e.TIP_ID = "iLoginCompShowTip",
    e.MASK_ID = "iLoginCompMask",
    e.YODA_SMS_VERIFY = "smdcodeYodaRoot",
    e.YODA_SEC_VERIFY = "secYodaRoot",
            ...
            tap: {
                addHandler: function(e, r) {
                    ...
                    e.addEventListener("touchstart", this.onTouchStart = function(e) {
                        ...
                        t = o - (a.last || o),
                        clearTimeout(s),
                        0 < t && t <= 250 && (a.isDoubleTap = !0),
                        a.last = o,
                        this.startTx = n.clientX,
                        this.startTy = n.clientY
                    },
                    !1),
                    e.addEventListener("touchend", this.onTouchEnd = function(e) {
                        var n = this;
                        e.preventDefault();
                        ...
                        250)) : (e.preventDefault(), a = {},
                        this.startTx = null, this.startTy = null, i = t = null, !1)
                    },
                    !1)
                },
                removeHandler: function(e) {
                    var n = this.onTouchStart,
                    o = this.onTouchEnd;
    ...
    t = function(e, n) {
        return void 0 === n && (n = ""),
        !!~ (e.className || "").split(/\s+/g).indexOf(n.trim())
    },
    i = function(e, n) {
        if (void 0 === n && (n = ""), 1 === e.nodeType) {
            ...
            t = e.className,
            i = t;
            t ? (o.forEach(function(e) {~t.indexOf(" " + e + " ") || (i += " " + e)
    ...
    function d(n, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) {
                ...
                n._value = e,
                void f(n);
                if ("function" == typeof o) return void g((t = o, i = e,
                function() {
                    t.apply(i, arguments)
                }), n)
            }
    ...
    function f(e) {
        ...
        for (var n = 0,
        o = e._deferreds.length; n < o; n++) c(e, e._deferreds[n]);
        e._deferreds = null
    }
    function m(e, n, o) {
        ...
        return new u(function(t, i) {
            ...
            function s(n, e) {
                try {
                    if (e && ("object" == typeof e || "function" == typeof e)) {
                        var o = e.then;
                        if ("function" == typeof o) return void o.call(e,
                        function(e) {
                            s(n, e)
                        },
                        i)
    ...
    u.race = function(i) {
        return new u(function(e, n) {
            for (var o = 0,
            t = i.length; o < t; o++) i[o].then(e, n)
        })
    },
    u._immediateFn = "function" == typeof setImmediate &&
    function(e) {
        setImmediate(e)
    } ||
    function(e) {
                ...
                if ("withCredentials" in t) {
                    ...
                    t.onload = function() {
                        if (4 === t.readyState) if (200 <= t.status && t.status < 300) {
                            ...
                            t = null
                        } else o(new Error(t.statusText)),
                        t = null
                    },
                    t.ontimeout = function(e) {
                        o(new Error("璇锋眰瓒呮椂:" + r)),
                        t = null
                    },
                    t.onerror = function() {
                        o(new Error(t.statusText)),
                        t = null
                    },
                    t.send(s)
    ...
    B = j(function(e) {
        ...
        o = R[n] || (R[n] = {}); (e.exports = function(e, n) {
    ...
    function(e, n, o) {
        var t, i, r, a, s = E(e),
        l = 0 < (t = s.length) ? P(S(t), 9007199254740991) : 0,
    ...
    re = j(function(e) {
        ...
        (e.exports = function(e, n, o, t) {
            ...
            i && (I(o, "name") || ie(o, "name", n)),
            e[n] !== o && (i && (I(o, r) || ie(o, r, e[n] ? "" + e[n] : a.join(String(n)))), e === R ? e[n] = o: t ? e[n] ? e[n] = o: ie(e, n, o) : (delete e[n], ie(e, n, o)))
    ...
    se = "prototype",
    le = function(e, n, o) {
        var t, i, r, a, s = e & le.F,
        l = e & le.G,
        c = e & le.S,
        u = e & le.P,
        d = e & le.B,
        p = l ? R: c ? R[n] || (R[n] = {}) : (R[n] || {})[se],
        f = l ? A: A[n] || (A[n] = {}),
        m = f[se] || (f[se] = {});
        for (t in l && (o = n), o) r = ((i = !s && p && void 0 !== p[t]) ? p: o)[t],
        a = d && i ? ae(r, R) : u && "function" == typeof r ? ae(Function.call, r) : r,
        p && re(p, t, r, e & le.U),
        f[t] != r && ie(f, t, a),
        u && m[t] != r && (m[t] = r)
    };
    ...
    de = (A.Object || {})[ce] || Object[ce],
    (pe = {})[ce] = ue(de),
    fe(fe.S + fe.F * W(function() {
        de(1)
    }), "Object", pe);
    ...
    Ne = {
        extraClass: "",
        loginBtnText: "鐧诲綍",
        codePlaceholder: "璇疯緭鍏ョ煭淇￠獙璇佺爜",
        phoneNumPlaceholder: "璇疯緭鍏ユ墜鏈哄彿",
        sendCodeText: "鍙戦€侀獙璇佺爜",
        sendCodePos: 1,
        cancelBtnText: "鍙栨秷",
        showCancel: !1
    },
    ...
    Se = function(e) {
        ...
        s = e.risk_partner,
        l = e.risk_app,
        c = e.risk_smsTemplateId,
        u = e.risk_smsPrefixId,
        d = e.uuid,
        p = void 0 === d ? "": d,
        f = e.componentId,
        m = void 0 === f ? "iLoginComp": f,
        g = e.api,
        h = void 0 === g ? "": g,
        v = e.loginSource,
        y = void 0 === v ? 0 : v,
        b = e.campaignPlatform,
        C = e.allCampaignId,
        w = e.specialRiskCode,
        k = e.tokenVersion,
        _ = void 0 === k ? 1 : k,
        x = e.officialAccount,
        I = e.callbackUrl,
        L = void 0 === I ? window.location.href: I,
        T = e.callbackFailUrl,
        E = void 0 === T ? window.location.href: T,
        N = e.LONGITUDE,
        O = void 0 === N ? "": N,
        S = e.LATITUDE,
        P = void 0 === S ? "": S,
        ...
        n = i,
        ve.env = n,
        "portm" === (o = h) || "" === o ? ve.api = o: console.error("api鐨勫€煎彧鏀寔portm鍜岀┖瀛楃涓�!"),
        {
            uiConfig: Ie({},
            Ne, r),
            componentId: m
        }
    }; (xe = _e || (_e = {})).loginApplyUrl = "mobileloginapply",
    xe.mobileLoginUrl = "mobilelogin",
    xe.verifyloginUrl = "verifylogin",
    xe.h5LoginApplyUrl = "h5loginapply",
    xe.h5loginUrl = "h5login",
    xe.h5authUrl = "h5auth";
    var Pe = function(e) {
        var n = Le[ye() || "prod"];
        return ("portm" === ve.api ? me(n).reduce(function(e, n) {
            return e[n] = "https://portal-portm.meituan.com/weapp/loginsdk/api/" + (ye() ? ye() + "/": "") + n,
            e
        },
        {}) : n)[e]
    },
                ...
                function m(e, n, o) {
                    ...
                    if ("undefined" != typeof document) {
                        if (1 < arguments.length) {
                            ...
                            n = f.write ? f.write(n, e) : encodeURIComponent(String(n)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent),
    ...
    Ue = function(n) {
        return C("https://portal-portm.meituan.com/weapp/loginsdk/api/uuid").then(function(e) {
            ...
            return 0 < n ? (console.log("鑾峰彇uuid閿欒锛岃閲嶈瘯"), Ue(n - 1)) : ""
        })
    },
    Ae = function(e, n) {
        return void 0 === n && (n = 1),
        je(e) ? (Fe(Me = e), u.resolve(Me)) : je(Me) ? (Fe(Me), u.resolve(Me)) : Ue(n).then(function(e) {
            return Fe(Me = e),
            Me
        })
    },
    Re = function(o) {
        return void 0 === o && (o = {}),
        me(o).reduce(function(e, n) {
            return null != o[n] && (e[n] = o[n]),
            e
        },
        {})
    },
    Be = navigator.userAgent.toLocaleLowerCase(),
    He = function() {
    ...
    ze = function(e) {
        ...
        if (n.type = "text/javascript", n.async = e.async || !1, n.src = e.src, "afterbody" === e.position) {
            ...
            if (o) o.parentNode.insertBefore(n, o);
            else document.getElementsByTagName("head")[0].appendChild(n)
        }
    },
    qe = function(e) {
    ...
    Qe = function(e, n) {
        var o, t = (o = e, Te() + "/v2/ext_api/" + o + "/info"),
        i = Ie(n, {
            _token: Ke(t)
        });
    ...
    function en(e, n, o) {
        ...
        for (var i = n ? We(n + "") : $e, r = o ? We(o + "") : Ze, a = i.length, s = r.length, l = [], c = 0, u = 0, d = 0, p = "", f = "", m = 0; m < e.length; ++m) {
            ...
            if (g === i[u]) {
                if (++u === a) {
                    ...
                    if ( - 1 === l.indexOf(p)) t[p] = f,
                    l[l.length] = p;
                    else(h = t[p]).pop ? h[h.length] = f: t[p] = [h, f];
                    p = f = "",
                    c = m + 1,
                    u = d = 0
                }
                ...
                if (u = 0, d < s) {
                    if (g === r[d]) {
                        if (++d === s) c < (v = m - d + 1) && (p += e.slice(c, v)),
                        c = m + 1;
                        continue
                    }
                    if (d = 0, 43 === g) {
        ...
        if (c < e.length) d < s ? p += e.slice(c) : u < a && (f += e.slice(c));
        else if (0 === d) return t; - 1 === l.indexOf(p) ? (t[p] = f, l[l.length] = p) : (h = t[p]).pop ? h[h.length] = f: t[p] = [h, f];
        return t
    }
    var nn, on, tn = {}; (on = nn || (nn = {})).SEND_SMSCODE_CLICK = "sendSmscodeClick",
    on.LOGIN_CLICK = "loginClick",
    on.LOGIN_COMPLETE = "loginComplete",
    on.COMP_INITED = "compInited",
    on.CANCEL_CLICK = "cancelClick";
    var rn = function() {
        function e() {
            this._callbacks = {}
        }
    ...
    function(e, n) {
        ...
        if (e && "undefined" != typeof document) {
            ...
            i.type = "text/css",
            "top" === o && t.firstChild ? t.insertBefore(i, t.firstChild) : t.appendChild(i),
    ...
    function() {
        ...
        this.init = function(e) {
            ...
            a ? (a.style.visibility = "hidden", a.innerHTML = (i = o, r = Oe.phone_num, "\n    <div id=" + s.YODA_SEC_VERIFY + " class='mtfe-secyoda-mtfe-wrapper'></div>\n    <div id=" + s.YODA_SMS_VERIFY + " class='mtfe-smscodeyoda-mtfe-wrapper'></div>\n    <div class=\"mtfe-tip-mtfe-wrapper\" id=" + s.TIP_ID + '></div>\n    <div class="mtfe-model-mtfe-wrapper" id=' + s.MODEL_ID + '></div>\n    <div class="mtfe-mask-mtfe-wrapper" id=' + s.MASK_ID + '></div>\n    <div class="iLoginComp-wrapper ' + i.extraClass + '" id=' + s.COMP_INNER + ">\n      <div class='iLoginComp-phone-num-wrapper'>\n        <input class='iLoginComp-phone-num-input'\n          id=" + s.PHONE_NUM_INPUT_ID + "\n          type='text'\n          maxlength=11\n          " + (r ? "value=" + r: "") + "\n          placeholder=" + i.phoneNumPlaceholder + ">\n          " + (1 === i.sendCodePos ? '<div class="iLoginComp-send-verify-code-text" id=' + s.CODE_ID + ">" + i.sendCodeText + "</div>": "<span></span>") + "\n      </div>\n      <div class='iLoginComp-verify-code-wrapper'>\n        <input class='iLoginComp-code-input'\n          id=" + s.CODE_INPUT_ID + "\n          type='text'\n          placeholder=" + i.codePlaceholder + ">\n          " + (2 === i.sendCodePos ? '<div class="iLoginComp-send-verify-code-text" id=' + s.CODE_ID + ">" + i.sendCodeText + "</div>": "<span></span>") + "\n      </div>\n      <div class='iLogincomp-opbtn-wrapper'>\n        <button class='iLoginComp-cancel-btn-wrapper' id=" + s.CANCEL_LOGIN + " style=" + (i.showCancel ? "": "display:none;") + ">\n          " + i.cancelBtnText + "\n        </button>\n        <button class='iLoginComp-login-btn-wrapper' id=" + s.LOGIN_ID + ">\n          " + i.loginBtnText + "\n        </button>\n      </div>\n    </div>\n  "), k.elementNodes = function(e) {
                ...
                return n
            } (k.idMap), k.bindEvents(), k.handlePhoneInput(Oe.phone_num), a.style.visibility = "visible", sn() && sn()._emit(nn.COMP_INITED)) : console.error("璇峰湪椤甸潰鏂板缓涓€涓猧d涓�" + t + "鐨刣iv瀹瑰櫒!")
        },
        this.bindEvents = function() {
            var e = Oe.isMobile ? "tap": "click";
            n.addHandler(k.elementNodes.sendCodeBtn, "click", k.onSendCodeClick),
            n.addHandler(k.elementNodes.loginBtn, e, k.onLoginClick),
            n.addHandler(k.elementNodes.cancelBtn, e, k.onCancelClick),
            n.addHandler(k.elementNodes.phoneNumInput, "input", k.onPhoneNumInput),
            n.addHandler(k.elementNodes.codeInput, "input", k.onCodeInput),
            n.addHandler(k.elementNodes.mask, "click", k.onMaskClick)
        },
        this.removeEvents = function() {
            var e = Oe.isMobile ? "tap": "click";
            n.removeHandler(k.elementNodes.sendCodeBtn, "click", k.onSendCodeClick),
            n.removeHandler(k.elementNodes.loginBtn, e, k.onLoginClick),
            n.removeHandler(k.elementNodes.cancelBtn, e, k.onCancelClick),
            n.removeHandler(k.elementNodes.phoneNumInput, "input", k.onPhoneNumInput),
            n.removeHandler(k.elementNodes.codeInput, "input", k.onCodeInput),
            n.removeHandler(k.elementNodes.mask, "click", k.onMaskClick)
        },
        this.clear = function() {
            k.removeEvents(),
            an.session = null
        ...
        this.showToast = function(e) {
            ...
            function(e) {
                ...
                msg: n,
                ele: void 0 === o ? k.elementNodes.tip: o,
        ...
        this.onSendCodeClick = function(e) {
            if (k.canSendCode) {
                ...
                qe(n) ? (k.canSendCode = !1, sn() && sn()._emit(nn.SEND_SMSCODE_CLICK), k.loginApplyHandle(n)) : k.showToast({
                    msg: "璇疯緭鍏ユ纭殑鎵嬫満鍙�"
                })
            }
        },
        this.loginApplyHandle = function(i) { (function(e) {
                if ("V3" === k.getLoginWay()) {
                    var n = Oe.loginSource,
                    o = Oe.campaignPlatform,
                    t = Oe.allCampaignId;
                    return i = {
                    ...
                    d = void 0 === u ? 2 : u,
                    p = i.specialRiskCode,
                    f = i.risk_smsTemplateId,
                    m = void 0 === f ? 0 : f,
                    g = i.risk_smsPrefixId,
                    h = void 0 === g ? 0 : g,
                    v = i.h5Fingerprint,
                    y = i.loginSource,
                    b = i.campaignPlatform,
                    C = i.allCampaignId,
                    Ae(r).then(function(e) {
                        ...
                        return void 0 !== p && (o.specialRiskCode = p),
                        _(Pe(_e.loginApplyUrl) + "?" + he(n), o).then(function(e) {
                            return console.log("mobileLoginApply res ==>", e),
                            e
                        })
                    })
                }
                ...
                _("" + Pe(_e.h5LoginApplyUrl), w, null, !0).then(function(e) {
                    return console.log("h5LoginApply res ==>", e),
                    e
                })
            })(i).then(function(e) {
                console.log("LoginApplyResponse", e),
                console.log("LoginApplyResponse2", JSON.stringify(e));
                var n, o = e.error;
                if (101190 === o.code) {
                    if (o.data) {
                        var t = o.data.requestCode; (n = t, window.XDomainRequest ? C(Ee() + "?requestCode=" + n).then(function(e) {
                            return e
                        }) : _(Ee(), {
                            requestCode: n
                        }).then(function(e) {
                            ...
                            if (e && 1 === e.status) {
                                ...
                                k.action = e.data.action,
                                k.extInfoParam = n,
                                k.requestExtInfo(k.action, k.extInfoParam)
                            }
                        })
                    }
                } else k.showToast({
                ...
                k.canSendCode = !0,
                k.showToast({
                    msg: "缃戠粶閿欒锛岃绋嶅悗閲嶈瘯锛�"
                })
            })
        },
        this.yodaSucc = function() {
            console.log("smscode楠岃瘉鎴愬姛锛�"),
            k.requestExtInfo(k.action, k.extInfoParam),
            Xe({
        ...
        this.yodaFail = function(e) {
            console.log("smscode楠岃瘉澶辫触锛�"),
            console.log("options=====>", e),
            k.showToast({
                msg: "楠岃瘉澶辫触锛岃绋嶅悗閲嶈瘯锛�"
            }),
            k.canSendCode = !0,
            Xe({
                yodaEle: k.elementNodes.yodaCode,
        ...
        this.secYodaSuccCb = function(e) {
            var n = e.requestCode,
            o = e.responseCode;
            console.log("secYodaSuccCb"),
            k.elementNodes.innerLoginComp.style.display = "block",
            k.elementNodes.secYoda.innerHTML = "";
        ...
        this.secYodaFailCb = function(e) {
            console.log("浜屾楠岃瘉澶辫触", e);
            var n = "";
            switch (e && e.code) {
            case 121061:
                n = "楠岃瘉淇℃伅鍒锋柊娆℃暟杩囧锛岃24灏忔椂涔嬪悗閲嶈瘯";
                break;
            default:
                n = "楠岃瘉澶辫触锛岃绋嶅悗閲嶈瘯锛�"
            }
        ...
        this.requestExtInfo = function(e, n) {
            Qe(k.action, n).then(function(e) {
                if (1 === e.status) return k.showToast({
                    msg: "楠岃瘉鐮佸凡鍙戦€�"
                }),
                void k.showCountdown();
                var n = e.error;
                if (!n.request_code) return console.log(n.message),
                k.showToast({
                    msg: n.message
                }),
                void(k.canSendCode = !0);
                var o = {
        ...
        this.onLoginClick = function(e) {
            if (k.canLogin) {
                ...
                k.extInfoParam && k.extInfoParam.request_code ? (sn() && sn()._emit(nn.LOGIN_CLICK), Je(k.action, o({},
                k.extInfoParam, {
                    smscode: n
                })).then(function(e) {
                    var n = e.status,
                    o = e.error;
                    0 !== n ? k.loginHandler(e && e.data && e.data.response_code) : k.showToast({
                        msg: o && o.message || "楠岃瘉閿欒"
                    })
                }).
                catch(function(e) {
                    console.log(e),
        ...
        this.loginHandler = function(e) {
            ...
            Ae(o.uuid).then(function(n) {
                ...
                return t.setCookie = !0,
                _(e, t, null, !0).then(function(e) {
                    return {
                        uuid: n,
                        loginInfo: e
                    }
                ...
                if (n && n.error) {
                    ...
                    function(e) {
                        if (e.msg) {
                            var n = "\n    <div style='color: #333'>鎻愮ず</div>\n    <div style='margin-top:1em;padding-bottom:1em;color: #888;font-size:.8em;'>" + e.msg + "</div>\n    <div style='padding-top:.5em;color:#06c1ae;border-top: 1px solid #e5e5e5;' id='iLoginComp-tip-id'>纭畾</div>\n  ";
                            e.ele.innerHTML = n,
                            Ve(e.maskEle),
                            document.getElementById("iLoginComp-tip-id").onclick = function() {
                                e.ele.style.display = "none",
                                Ge(e.maskEle),
                                e.cb && "function" == typeof e.cb && e.cb()
                            }.bind(window),
                            e.ele.style.display = "block"
                        }
                    } ({
                        msg: o.message,
                        ele: k.elementNodes.model,
                        cb: function() {
                            var e = r.param,
                            n = r.userTicket;
                            tn.userTicket = n;
                            ...
                            if (101157 === i) {
                                ...
                                ye() ? YodaSeed(t, ye()) : YodaSeed(t),
                                k.elementNodes.innerLoginComp.style.display = "none"
                            }
                        },
                        maskEle: k.elementNodes.mask
                    })
            ...
            _("" + Pe(_e.h5loginUrl), n, null, !0).then(function(e) {
                return console.log("h5Login loginInfo ==>", e),
                e
            })).then(function(e) {
                console.log(e),
                e && e.error ? k.showToast({
                    msg: e.error.message
                }) : sn() && sn()._emit(nn.LOGIN_COMPLETE, {
                    user: e,
                    mobile: k.extInfoParam.mobile
                })
            }).
        ...
        this.onPhoneNumInput = function(e) {
            ...
            k.handlePhoneInput(n)
        },
        this.handlePhoneInput = function(e) {
            11 <= e.length && qe(e) && !k.countdowning ? (t(k.elementNodes.sendCodeBtn, "iLogincomp-active") || i(k.elementNodes.sendCodeBtn, "iLogincomp-active"), k.canSendCode = !0) : (r(k.elementNodes.sendCodeBtn, "iLogincomp-active"), k.canSendCode = !1),
            k.toggleLoginBtn()
        },
        this.onCodeInput = function(e) {
            var n = e.target.value;
            6 <= n.length && (e.target.value = n.substr(0, 6)),
            k.toggleLoginBtn()
        },
        ...
        this.showCountdown = function() {
            k.countdowning = !0,
            r(k.elementNodes.sendCodeBtn, "iLogincomp-active"),
            k.elementNodes.sendCodeBtn.innerHTML = '<span class="iLogincomp-count-down"><span id="iLoginCounDown" ></span>s</span>',
            y(60, document.getElementById("iLoginCounDown")).then(function() {
                k.canSendCode = !0,
                k.countdowning = !1,
                i(k.elementNodes.sendCodeBtn, "iLogincomp-active"),
                k.elementNodes.sendCodeBtn.innerHTML = k.uiConfig.sendCodeText
            })
        },
        ...
        this.thirdLogin = function(e) {
            k.isThirdEnv() && "succ" !== k.urlQueryObj.thirdLogin && "fail" !== k.urlQueryObj.thirdLogin && k.getThirdLoginParam(e).then(function(e) {
                console.log("param=======>", he(e)),
                window.location.href = Pe(_e.h5authUrl) + "?" + he(e)
            })
        },
        this.getThirdLoginParam = function(e) {
            return Se(e),
            Ae(Oe.uuid).then(function(e) {
                var n = {
        ...
        this.canSendCode = !1,
        this.countdowning = !1,
        this.session = (e = new rn, an.session = e, an.session),
        this.urlQueryObj = this.urlQueryToObj(window.location.search.substring(1)),
        this.action = "V3" === this.getLoginWay() ? "login": "thirdlogin"
    },
