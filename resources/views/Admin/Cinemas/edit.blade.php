        ...
        <div class="content-wrapper">
          <div class="row"> 
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">影院修改</h4>
                  <p class="card-description">
                    <!-- Basic form elements -->
                  </p>
                  <!-- <div class="mws-panel-body no-padding">  -->
                  <form class="forms-sample" action="/admincinemas/{{$info->id}}" method="post" enctype="multipart/form-data">
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="影院名" name="name"  value="{{$info->name}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword4">影院地址</label>
                      <input type="text" class="form-control" id="exampleInputPassword4" placeholder="影院地址" name="address" value="{{$info->address}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPhone3">联系电话</label>
                      <input type="text" class="form-control" id="exampleInputPhone3" placeholder="联系电话" name="tel" value="{{$info->tel}}">
                    </div> 
                    <div class="form-group">
                      <label for="exampleInputPassword4">目前图片&nbsp:&nbsp</label>
                      <img src='../uploads/cinemas/{{$info->pic}}' width="200px">
                    </div>    
                    <div class="form-group">
                      <label for="exampleInputPassword4">修改图片&nbsp:&nbsp</label>
