...
function() {
    ...
    var w = {
        get: function(t) {
            ...
            n = "".concat(t, "="), r = n.length, i = e.length, a = 0; a < i;) {
                var o = a + r;
                if (e.substring(a, o) === n) return s = o,
                u = c = void 0,
                c = document.cookie,
                -1 === (u = c.indexOf(";", s)) && (u = c.length),
                decodeURIComponent(c.substring(s, u));
        ...
        set: function(t, e, n, r, i, a) {
            i = i || (o = document.domain, "localhost:" === o ? "": ("undefined" != typeof M && M.DOMAIN_HOST && (o = ".".concat(M.DOMAIN_HOST)), "www." === o && (o = o.substring(0, 4)), o));
            var o;
        ...
        getExpire: function(t, e, n) {
            var r = new Date;
            if (d(t) && d(e) && d(n)) return r.setDate(r.getDate() + parseInt(t, 10)),
    ...
    var _ = {
        ...
        emit: function() {
            ...
            var r = e[0],
            i = e.slice(1);
            if (b[r]) for (var a = 0; a < b[r].length; a++) b[r][a].apply(this, i)
        },
            ...
            value: function(t) { !
                function(t) {
                    if ("file:" !== window.location.protocol) {
                        ...
                        t);
                        if (window.XDomainRequest) try { (e = new XMLHttpRequest).open(n.method, n.url),
                            e.send(l(n.data))
                        } catch(t) {} else if (window.XMLHttpRequest && "withCredentials" in (e = new XMLHttpRequest)) try {
    ...
    k = function() {
        function r() {
            i(this, r),
            a(this, "_COOKIE_USER_TRACKING", "__mta");
            var t = window.screen,
            e = window.navigator,
            n = this._getViewport();
        ...
        },
        {
            ...
            value: function() {
                ...
                e = t.navigator,
                n = t.history.length,
                r = e.appName + e.appVersion + this._getEnvLanguage() + e.platform + e.userAgent + this.javaEnabled + this.screen + (document.cookie ? document.cookie: "") + (document.referrer ? document.referrer: ""), i = r.length; 0 < n;) r += n--^i++;
                return function(t) {
                    var e, n = 1,
                    r = 0;
    ...
    C = function() {
        function s(t) {
            i(this, s),
            a(this, "_PERF_CATEGORY", "fe_perf_web"),
            a(this, "_SEND_DELAY", 100),
            ...
            t),
            this.client = new k,
            this.beacon = new E(this.trackerConfig.url),
        ...
        },
        {
            key: "tag",
            value: function(t, e) {
                "string" == typeof t && t.length && (void 0 !== c(e) ? this._tags[t] = e: delete this._tags[t])
            }
        },
        {
            key: "execute",
            ...
            value: function(t, e, n, r) {
                ...
                if (t && !( - 1 < ["xhr-dispatch", "xhr-result.load", "browser.xhr"].indexOf(t))) if ("resources" !== t) {
                    if (! (e && e.url && /catfront|dreport/.test(e.url))) {
                        ...
                        var o = {};
                        e && (o[t] = e, this._push(r || "timer", o, n)),
            ...
            value: function() {
                ...
                if (this._isSampleHit()) {
                    ...
                    if (this._queue.length) {
                        if (t) 1 === this._queue.length ? a = this._formatLogType(this._queue[0]) : m(this._queue,
                        function(t) {
                            var e; (e = a).push.apply(e, f(n._formatLogType(t)))
                        }),
                        i = this._formatReportData(r, a),
                        _.emit("data", i),
                        this.beacon.send(i);
                        else for (var o = 0; o < this._queue.length; o++) i = this._formatReportData(r, this._formatLogType(this._queue[o])),
                        _.emit("data", i),
                        this.beacon.send(i);
                        this._queue = []
                    }
        ...
        },
        {
            ...
            key: "addPlugin",
            value: function(t, e) {
                if (!g(e.data)) throw new Error("Can't add plugin ".concat(t, ". The plugin object of data props should be") + " a function, but its type is ".concat(c(e.data)));
                s.plugins[t] = e
            }
        }]),
        s
    ...
    P = {
        ...
        data: function() {
            ...
            if (t) {
                ...
                if ("object" === ("undefined" == typeof M ? "undefined": c(M)) && M.subresources && M.subresources.names && void 0 !== window.SubResoucesTiming) {
                    var n = M.subresources.lastImage || "",
                    i = M.subresources.firstImage || "",
                    a = new window.SubResoucesTiming(M.subresources.names, n, i);
                    a.length && "fsImg" === a[a.length - 1].id && (r.atf = a[a.length - 1].start, r.c_atf = a[a.length - 1].start - S(e.responseStart, e.navigationStart))
                }
                try {
                ...
                if (!r.firstPaint && e.msFirstPaint && "number" == typeof e.msFirstPaint && (r.firstPaint = S(e.msFirstPaint, e.navigationStart)), !r.firstPaint && window.chrome && window.chrome.loadTimes) {
                    ...
                    r.firstPaint = Math.round(1e3 * S(o.firstPaintTime, o.startLoadTime))
                }
                return ("number" != typeof r.firstPaint || r.firstPaint < 0) && (r.firstPaint = void 0),
                "undefined" != typeof M && M.TimeTracker && M.TimeTracker.fst && (r.firstScreen = S(M.TimeTracker.fst, e.navigationStart)),
                r
            }
        }
    },
    ...
    C.addPlugin("browser.page.business", I),
    C.addPlugin("fps", R),
    C.addPlugin("page", P),
    C.addPlugin("resources", j),
    O = function() {
