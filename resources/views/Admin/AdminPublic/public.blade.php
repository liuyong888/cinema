...
<ul class="sidebar-panel nav">
  ...
  <li><a href="#"><span class="icon color8"><i class="fa fa-flask"></i></span>人员管理<span class="caret"></span></a>
    <ul>
      <li><a href="/adminrenyuan">人员列表</a></li>
      <li><a href="/adminrenyuan/create">人员添加</a></li>
    </ul>
  </li>
  <li><a href="#"><span class="icon color8"><i class="fa fa-flask"></i></span>评论管理<span class="caret"></span></a>
    <ul>
      <li><a href="/adminpinglun">评论列表</a></li>
      <li><a href="/adminpinglun/create">评论添加</a></li>
    </ul>
  </li>
