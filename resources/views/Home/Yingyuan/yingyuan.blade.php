...
<head>
  ...
  <link rel="stylesheet" href="/static/Home/yystatic/css/common.4b838ec3.css"/>
<link rel="stylesheet" href="/static/Home/yystatic/css/cinemas-list.81574a4d.css"/>
  <script crossorigin="anonymous" src="/static/Home/yystatic/js/stat.74891044.js"></script>
  <script>if(window.devicePixelRatio >= 2) { document.write('<link rel="stylesheet" href="/static/Home/yystatic/css/image-2x.8ba7074d.css"/>') }</script>
  <style>
    @font-face {
...
<div class="footer">
    ...
    <script crossorigin="anonymous" src="/static/Home/yystatic/js/owl_1.7.11.js"></script>
    <script>
      Owl.start({
    ...
    <!--[if IE 8]><script crossorigin="anonymous" src="/static/Home/yystatic/js/es5-shim.bbad933f.js"></script><![endif]-->
    <!--[if IE 8]><script crossorigin="anonymous" src="/static/Home/yystatic/js/es5-sham.d6ea26f4.js"></script><![endif]-->
    <script crossorigin="anonymous" src="/static/Home/yystatic/js/common.1a4cea09.js"></script>
<script crossorigin="anonymous" src="/static/Home/yystatic/js/cinemas-list.edf550e8.js"></script>
</body>
</html>
