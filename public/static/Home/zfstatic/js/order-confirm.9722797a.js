webpackJsonp([18], {
    0 : function(e, t, n) {
        ...
        function a() { (0, u.checkLogin)(function() {
                $.ajax({
                    method: "GET",
            ...
            $.post({
                ...
                success: function(e) {
                    if (e) {
                        ...
                        o.find("input[name=token]").val(system.user.token),
                        o.find("input[name=tradeno]").val(e.tradeNo),
                        o.find("input[name=pay_token]").val(e.payToken),
                        o.find("input[name=pay_success_url]").val(n),
                        o.submit()
                    }
                }
            })
