                  ...
                  <table class="table table-bordered" style="text-align: center;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="td-manage">
                          <a style="text-decoration:none;float:left;" href="/adminuser/{{$row->id}}/edit">
                          ...
                          <form action="/adminuser/{{$row->id}}" method="post" style="float: right;">
                              {{csrf_field()}}
                              {{method_field("DELETE")}}
                              <button type="submit" class="btn btn-gradient-danger btn-rounded btn-sm" title="删除此管理员"><font style="vertical-align: inherit;"><i class="mdi mdi-delete"></i></font></button>
                          </form>
                        </td>
                      </tr>
                      @endforeach
