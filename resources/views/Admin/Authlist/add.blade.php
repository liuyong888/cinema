        ...
        <div class="panel-title">
          ...
          <ul class="panel-tools">
            ...
            <div class="panel-body">
              <form class="form-horizontal" action="/authlist" method="post">
                    @if (count($errors) > 0)
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input11" placeholder="" name="name">
                  </div>
                </div>
                  <div class="form-group">
                  <label class="col-sm-2 control-label form-label">控制器</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input11" placeholder="" name="mname">
                  </div>
                </div>
                  <div class="form-group">
                  <label class="col-sm-2 control-label form-label">方法</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input11" placeholder="" name="aname">
                  </div>
                </div>
