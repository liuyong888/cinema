        ...
        <div class="panel-title">
          ...
          <ul class="panel-tools">
            ...
            <div class="panel-body">
              <form class="form-horizontal" action="/filmarea" method="post">
                    @if (count($errors) > 0)
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="input11" placeholder="请输入电影地区" name="area_name">
                  </div>
                </div>
