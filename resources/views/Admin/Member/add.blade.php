        ...
        <div class="content-wrapper">
          <div class="row"> 
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">会员添加</h4>
                  <p class="card-description">
                    <!-- Basic form elements -->
                  </p>
                  <!-- <div class="mws-panel-body no-padding">  -->
                  <form class="forms-sample" action="/adminmember" method="post">
                    @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="请输入会员名" name="name" >
                    </div>
                    <div class="form-group">
